...
if __name__ == "__main__":
    ...
    parser.add_argument("-u", "--upstream", default=defaults["upstream"], metavar="<dns server:port>", dest="upstream",
                        ...
                        "(default: %(default)s)")
    parser.add_argument("-t", "--timeout", default=defaults["timeout"], type=int, metavar="<timeout>", dest="timeout",
                        help="timeout for the server to resolve queries "
                        "(default: %(default)s)")
    parser.add_argument("--log-format", default=defaults["log_format"], metavar="<log_format>", dest="log_format",
    ...
    parser.add_argument("--log-prefix", action="store_true", default=defaults["log_prefix"], dest="log_prefix",
                        ...
                        "(default: %(default)s)")
    parser.add_argument("--save-config", nargs="?", default=False, const="dns_proxy_settings.ini", type=str, metavar="config_file", dest="save_config",
    ...
    parser.add_argument("-x", "--exceptions", nargs="+", default={}, metavar="<domain:ip domain:ip ...>", dest="exceptions",
                        ...
                        "(default: %(default)s)")
    parser.add_argument("--logs-file", default=default_logs_file, metavar="<logs_file>", dest="logs_file",
    ...
    main((address, port), (upstream_address, upstream_port), timeout, log_format, log_prefix, parse_logs_file(logs_file, default_value=default_logs_file), map_, exceptions_)
