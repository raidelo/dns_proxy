...
from dnslib.server import QTYPE, RCODE, RR, DNSHandler, DNSLogger, DNSServer
...
def main(
    local_server_address=("0.0.0.0", 53),
...
if __name__ == "__main__":
    ...
    if args.save_config or not args.use_args:
        ...
        config_file_route = (
            args.save_config if args.save_config else "dns_proxy_settings.ini"
        )
